...
# Version:              1.4
# This Script will Download 3 additional versions of PHP. The versions are 5.4.45, 5.5.31, 5.6.17. Will setup and install each version of php with php-fpm or php-cgi support
...
declare -a my_php_versions=('5.4.45' '5.5.31' '5.6.17')
